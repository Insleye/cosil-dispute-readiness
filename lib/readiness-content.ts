...
export const questions = [
  ...
  { id:"q5_4", dimension:"optionsAwareness", prompt:"How confident are you that you know when general information stops being enough and your own circumstances need individual professional consideration?", options:[["I am not sure where that boundary sits",0],["I have a general sense, but I am not always sure",1],["I can broadly distinguish general information from circumstances that require individual consideration",2]] },
